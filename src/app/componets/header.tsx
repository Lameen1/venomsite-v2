...
function Header() {
  const [toggle, setToggle] = useState(false)
    ...
    return (
      <>
      <div className="flex bg-white h-20 sticky top-0 z-[200] shadow headtrans">
        <ul className="w-full flex gap-4 lg:gap-14 items-center text-darkpurple lg:text-base text-sm font-vfont font-bold">
          ...
          <li><a className="hidden sm:flex " href="/news">News</a></li>
          <li><a className="hidden sm:flex " href="/schedule">Schedule</a></li>
          <li><a className="hidden sm:flex " href="/roster">Roster</a></li>
          <li><a className="hidden sm:flex " href="/stats">Stats</a></li>
          <li><a className="hidden sm:flex " href="/coaches">Coaches</a></li>
          <li><a className="hidden sm:flex " href="/about">About Us</a></li>
          <li><a className="hidden sm:flex " href="/contact">Contact Us</a></li>
        </ul>
